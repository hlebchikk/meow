...
class WorkParser:
    ...
    def scroll_through_pages(self):
        while True:
            ...
            cards = vacancy_container.find_elements(By.CLASS_NAME, "card")
            self.vacancy_cards.extend(cards)
    ...
    def collect_all_vacancy_cards(self):
    ...
    def play(self):
        self.collect_all_vacancy_cards()
        self.scroll_through_pages()
